...
// read agreement list from json file and create new agreements with existing agreement data
...
const getAgreement = async (agmtNumber) => {
  ...
  console.log("Fetching:", agmtNumber);
  console.log(post);
};

getAgreement("MOMPTKR25010222");
